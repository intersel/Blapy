...
<head>
	<title data-upi-container="true" data-upi-container-name="Title" data-upi-container-content="<?php echo basename($_SERVER["SCRIPT_FILENAME"]);?>"><?php echo $defaultTitle?></title>
