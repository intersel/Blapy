...
Blapy is json compliant too and eases the integration of ajax/rest API with templating and routing services very simple to use... Blapy will be the "V-iew" in the MVC approach...
...
=================
  ...
  * [FAQ](#faq)
    ...
    * [How to set conditional output in a json template](#how-to-set-conditional-output-in-a-json-template)
      * [Example](#example-5)
        * [Initial blapy definition](#initial-blapy-definition)
        * [Example of data that could be sent to Blapy by myInitFile.php](#example-of-data-that-could-be-sent-to-blapy-by-myinitfilephp)
    ...
    * [How to send "pure" json as response to a query ?](#how-to-send-pure-json-as-response-to-a-query-)
      * [Json has no information about blapy blocks](#json-has-no-information-about-blapy-blocks)
        * [Example](#example-6)
      * [The returned Json content is Blapy oriented](#the-returned-json-content-is-blapy-oriented)
        * [Example of a response to a blapy call](#example-of-a-response-to-a-blapy-call)
